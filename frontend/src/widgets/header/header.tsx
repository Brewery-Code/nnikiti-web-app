...
export default function Header() {
  return (
    <header className="absolute flex justify-center w-full h-20 bg-black before:absolute before:-bottom-5 before:w-full before:h-5 before:bg-[linear-gradient(180deg,_rgba(0,0,0,1)_0%,_rgba(0,0,0,0)_100%)]">
      <div className="container-base flex justify-between items-center h-full">
        <MicrocircuitLabelLogo />
        <ul className="flex items-center gap-4 xl:gap-6 text-sm xl:text-base leading-6 font-semibold">
