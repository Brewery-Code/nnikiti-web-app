...
export default function UserMenu() {
  const userData = (rqClient.useQuery("get", "/users/me/", {}).data) as { avatar?: string; first_name?: string } | undefined;
  const userRole = (publicRqClient.useQuery("get", "/users/role/", {}).data) as { role?: string } | undefined;
