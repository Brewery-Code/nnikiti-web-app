...
export const DEPARTMENTS_DATA: DepartmentData[] = [
  {
    ...
    description:
      "Кафедра вищої математики — базовий підрозділ ННІКІТІ, що забезпечує математичну підготовку студентів усіх спеціальностей інституту. Викладачі кафедри мають значний досвід науково-педагогічної роботи і провадять дослідження у сфері прикладної математики, чисельних методів та математичного моделювання.",
    ...
    history: [
      ...
      { year: "2019", text: "Після реорганізації кафедра увійшла до складу ННІКІТІ та оновила навчальні плани відповідно до стандартів Нової освіти." },
  ...
  },
  {
    ...
    description:
      "Кафедра є одним із ключових підрозділів ННІКІТІ, що готує фахівців на перетині інформаційних технологій та економіки. Студенти отримують ґрунтовну підготовку з розробки програмного забезпечення, економічного аналізу та бізнес-інтелекту.",
    ...
    history: [
      ...
      { year: "2013", text: "Разом з усім інститутом кафедра увійшла до складу ННІКІТІ. Встановлено партнерство з IT-компаніями регіону для практичного навчання студентів." },
  ...
  },
  {
    ...
    history: [
      ...
      { year: "2019", text: "Кафедра реструктурована у складі ННІКІТІ, розпочато підготовку за спеціальністю «Кібербезпека» відповідно до нових стандартів вищої освіти." },
