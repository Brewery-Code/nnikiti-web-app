...
export default function PartnersSection({ className = "" }: { className?: string }) {
  ...
  return (
    <section className={className}>
      ...
      <div className="scrollbar-hidden flex flex-col gap-4 overflow-x-scroll px-8">
        <div className="flex gap-4">
          ...
          >
            <img className="h-full w-full object-contain" src={partner1Img} alt="" />
          </PartnerCard>
          <PartnerCard
            className="shrink-0"
            colSpan={Math.floor(Math.random() * 3)}
            rowSpan={Math.floor(Math.random() * 3)}
          >
            <img className="h-full w-full object-contain" src={partnerImg} alt="" />
          </PartnerCard>
          <PartnerCard
            className="shrink-0"
            colSpan={Math.floor(Math.random() * 3)}
