...
function ContactBlockComponent({
  ...
  return (
    <div
      className={clsx(
        "flex flex-col gap-4 h-auto p-4 rounded-xl bg-fixed bg-[linear-gradient(135deg,_rgba(30,39,255,0.1)_0%,_rgba(246,0,255,0.1)_50%,_rgba(255,141,0,0.1)_100%)] shadow-xl",
        "gradient-animation",
        className
      )}
    >
