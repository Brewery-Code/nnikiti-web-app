...
import { PROGRAM_DEPARTMENTS, isMasterDegree, type ProgramData } from "./model";
    ...
    <section className="py-12 sm:py-16 lg:py-20">
      ...
      {fits ? (
        ...
        <div className="overflow-hidden py-3">
          ...
          >
            {programs.map((p) => (
              <SwiperSlide key={p.id} className="!w-[72vw] sm:!w-[300px] lg:!w-[340px] xl:!w-[380px] 2xl:!w-[420px]" style={{ backfaceVisibility: "hidden", WebkitBackfaceVisibility: "hidden" }}>
                <SpecCard spec={p} />
              </SwiperSlide>
            ))}
          </Swiper>
